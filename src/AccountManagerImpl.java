...
public class AccountManagerImpl implements AccountManager {
    ...
    /**
     * createPlayer(String name) ueberprueft, ob schon ein Spieler mit dem Namen existiert, wenn das der Fall ist wird eine DuplicationException geworfen
     */
    ...
    /**
     * extendPlayerArray() vergroesert die playerArray um 10 Plaetze.
     */
    ...
    /**
     * addPlayer(Player tmp) adds Player to the playerArray, if to short, extends Array;
     */
    ...
    /**
     * checkPlayerDouplication(String playerName) sucht in der playerArray nach Spielern mit dem gleichen Namen
     */
    ...
    /**
     * getAssetValue(String playerName) gibt den AKTUELLEN Wert von CashAccount und Deposit eines Spielers zurueck
     */
    public long getAssetValue(String playerName) {
        Player foundPlayer = findPlayer(playerName);
        long value = foundPlayer.getDeposit().getCurrentValue() + foundPlayer.getAccount().getAccountStatus();
        return value;
    }
